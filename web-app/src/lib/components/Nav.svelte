<div class=" text-black  top-0 left-0 right-0 z-50 py-2 text-center">
    <a href="/">
        ...
        <img src="/src/static/cartoonsketches500.png" alt="Description of the image" width="90" height="30" class="mx-auto">
    </a>
</div>
...
<div class=" text-black top-40 left-0 right-0 z-50 text-center border border-black mb-5 shadow-[0_3px_3px_rgba(0,0,0,0.3)]" >
    <div class="px-4 py-2 font-body text-black font-regular text-base">
        <nav class="container mx-auto flex justify-evenly items-center">
            ...
            <a class="nav-link px-4 hover:text-red-500" href="/about"><i>ABOUT</i></a>
            <a class="nav-link px-4 hover:text-red-500" href="/learn"><i>LEARN</i></a>
            <a class="nav-link px-4 hover:text-red-500" href="/contact"><i>CONTACT</i></a>
        </nav>
    </div>
</div>